...
public class CadastroProntuario extends javax.swing.JInternalFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            oEProntuario.setMedico(new PMedico().consultar(Integer.valueOf(jtextMedico.getText())));
            oEProntuario.setPaciente(new PPaciente().consultar(Integer.valueOf(jtextPaciente.getText())));
